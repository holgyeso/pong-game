...
public class SetWinnerScoreView extends SettingsView {

    private final JSpinner spinner;
    private Color colorYellow = new Color(251, 209, 4);
    private final JButton save;

    public SetWinnerScoreView() {
        super("Set winner's score", "Change below the score when a player wins and then press save!", 300);
        ...
        JLabel spinnerLabel = new JLabel("Winners' score:");
        ...
        SpinnerModel spec = new SpinnerNumberModel(SettingsController.getWinnerScore(), 1, 15, 1);
    ...
    public JSpinner getWinnerScoreSpinner() {
        return spinner;
    }
